...
void showpage2(void)
{
	...
	OLED_ShowString(0,48,"LED3:",16,1); 
	if(LED1==0)OLED_ShowChinese(40,16,10,16,1);
	else OLED_ShowChinese(40,16,9,16,1);
	if(LED2==0)OLED_ShowChinese(40,32,10,16,1);
	else OLED_ShowChinese(40,32,9,16,1);
	if(BEE==0)OLED_ShowChinese(40,48,10,16,1);
	else OLED_ShowChinese(40,48,9,16,1);
