...
int main(void)
{
	...
	while(1)
	{
		...
		{	
			...
			if(strcmp((char *)USART_RX_BUF,"openled")==0)GPIO_ToggleBits(GPIOE,GPIO_Pin_8 |GPIO_Pin_9 | GPIO_Pin_10);
			if(strcmp((char *)USART_RX_BUF,"closeled")==0)GPIO_ToggleBits(GPIOE,GPIO_Pin_8 |GPIO_Pin_9 | GPIO_Pin_10);
