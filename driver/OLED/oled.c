...
void showpage1(void)
{
	...
	OLED_ShowChinese(20,16,1,16,1);//��
	OLED_ShowChinese(40,16,2,16,1);//Զ
	OLED_ShowChinese(60,16,3,16,1);//��
	OLED_ShowChinese(80,16,4,16,1);//��
	OLED_ShowChinese(100,16,5,16,1);//��
...
void showpage2(void)
{
	...
	OLED_ShowChinese(40,0,2,16,1);//Զ
	OLED_ShowChinese(60,0,3,16,1);//��
	OLED_ShowChinese(80,0,4,16,1);//��
	OLED_ShowChinese(100,0,5,16,1);//��
	OLED_ShowChinese(72,16,13,16,1);//��
	OLED_ShowChinese(88,16,14,16,1);//��
	OLED_ShowString(104,16,":",16,1);
	OLED_ShowNum(72,32,Get_Adc_Average(),4,16,1);
	if(Get_Adc_Average()<=1000)OLED_ShowChinese(95,48,11,16,1);//ǿ
	else OLED_ShowChinese(95,48,12,16,1);//��
...
void showpage3(void)
{
	...
	OLED_ShowChinese(25,0,17,16,1);//��
	OLED_ShowChinese(50,0,18,16,1);//��
	OLED_ShowChinese(75,0,19,16,1);//ʪ
	OLED_ShowChinese(100,0,20,16,1);//��
	
	OLED_ShowChinese(0,16,18,16,1);//��
	OLED_ShowChinese(25,16,20,16,1);//��
	OLED_ShowString(41,16,":",16,1);
	OLED_ShowNum(50,16,temp_val,2,16,1);

	OLED_ShowChinese(0,32,19,16,1);//ʪ
	OLED_ShowChinese(25,32,20,16,1);//��
	OLED_ShowString(41,32,":",16,1);
